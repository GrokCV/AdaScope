...
class SIRSTVOCDetClusterDataset(XMLDataset):
    ...
    def __init__(self, img_subdir="PNGImages", ann_subdir="SIRST/Cluster", **kwargs):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for img_id in img_ids:
            ...
            xml_path = osp.join(self.sub_data_root, self.ann_subdir, f"{img_id}_with_clusters.xml")


            
            img_path = osp.join(self.data_root, file_name)



            raw_img_info = {}
            # 将 img_path 加入字典，解决 LoadImageFromFile 的 KeyError
    ...
    def _parse_instance_info(
        ...
        """
        instances = []
        for obj in raw_ann_info.findall("cluster"):
            instance = {}
