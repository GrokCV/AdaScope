# dataset settings
## 加载单目标 ，通过网格训练模型
dataset_type1 = "deepir.SIRSTVOCDetSegDataset"

## 加载成簇，通过成簇框验证性能
dataset_type2 = "deepir.SIRSTVOCDetClusterDataset"
...
# data_root = 's3://openmmlab/datasetcd s/detection/segmentation/VOCdevkit/'
