...
model = dict(
    ...
    test_cfg=dict(nms_pre=3000, min_bbox_size=0, score_thr=0.001, nms=dict(type="nms", iou_threshold=0.7), max_per_img=1000),
)

optim_wrapper = dict(type="OptimWrapper", optimizer=dict(type="SGD", lr=0.0003, momentum=0.9, weight_decay=0.0001))
