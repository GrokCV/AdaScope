...
custom_imports = dict(
    imports=[
        ...
        'deepir.models.detectors.plain_flat_sync_clean_sac_detector',
        'deepir.models.refine.plain_template_three_action_clean_sac_refiner',
    ],
...
WORK_DIR = osp.join(
    REPO_ROOT,
    'work_dirs',
    'c5_clean_plainsac24_flatdet_threeaction_template3stage_densesirst_disconnected',
)
...
model = dict(
    type='PlainFlatSyncCleanSACDetector',
    rl_algorithm='sac',
    ...
    refiner=dict(
        type='PlainTemplateThreeActionCleanSACRefiner',
        in_channels=256,
        feat_channels=256,
        num_ins=5,
        fusion_level=2,
