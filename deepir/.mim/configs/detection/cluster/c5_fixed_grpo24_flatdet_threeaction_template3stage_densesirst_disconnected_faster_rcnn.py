...
custom_imports = dict(
    imports=[
        ...
        'deepir.models.dense_heads.composite_faster_rcnn_head',
        'deepir.models.detectors.fixed_flat_sync_grpo_faster_rcnn_detector',
        'deepir.models.refine.fpn_template_three_action_grpo_refiner',
    ],
    allow_failed_imports=False,
)

REPO_ROOT = '/root/data-tmp/AsyncDetv2'
...
model = dict(
    type='FixedFlatSyncGRPOFasterRCNNDetector',
    ...
    refiner=dict(
        type='FPNTemplateThreeActionGRPORefiner',
        in_channels=256,
        feat_channels=256,
        num_ins=5,
        fusion_level=2,
    ...
    external_local_cfg='configs/detection/cluster/local_proxy/faster_rcnn_r50_fpn_1x_densesirst_plugin.py',
    external_local_ckpt='',
    roi_source='refined',
    ...
    grpo_area_budget=6.0,
    grpo_cover_keep_ratio=0.85,
    grpo_dense_min_gt=0,
    grpo_advantage_eps=1e-6,
    grpo_ref_kl_weight=0.0,
    grpo_ref_kl_loss_scale=0.0,
    grpo_ref_kl_safe_max=0.0,
...
custom_hooks = [
    dict(
        ...
        reference_metric_key='pascal_voc/mAP',
    ),
]
...
work_dir = osp.join(
    REPO_ROOT,
    'work_dirs',
    'c5_fixed_grpo24_flatdet_threeaction_template3stage_densesirst_disconnected_faster_rcnn',
)
