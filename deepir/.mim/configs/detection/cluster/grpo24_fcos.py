...
model = dict(
    ...
    # ===== 修复三个问题的核心配置 =====
    # 问题1验证集泄漏、问题2延迟反馈、问题3过拟合风险
    # 通过禁用参考策略机制来解决
    grpo_ref_kl_weight=0.0,           # 原值 0.02 → 0.0
    grpo_ref_kl_loss_scale=0.0,       # 原值 10.0 → 0.0
    grpo_ref_kl_safe_max=0.0,         # 原值 200.0 → 0.0
    grpo_use_reference_policy=False,  # 原值 True → False
    # 删除 grpo_reference_metric_key='merged_voc/mAP'
    # 删除 grpo_seed_reference_on_stage_enable=True
