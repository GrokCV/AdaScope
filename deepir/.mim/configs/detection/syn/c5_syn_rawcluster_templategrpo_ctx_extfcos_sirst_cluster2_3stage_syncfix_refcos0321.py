...
model = dict(
    ...
    external_local_ckpt='/opt/data/private/cjt/BAFE-Net/checkpoints/fcos_r50-caffe_fpn_gn-head_1x_densesirst_20260321_best.pth',
    roi_source='refined',
...
work_dir = '/opt/data/private/cjt/BAFE-Net/work_dirs/c5_syn_rawcluster_templategrpo_ctx_extfcos_sirst_cluster2_3stage_syncfix_refcos0321'
