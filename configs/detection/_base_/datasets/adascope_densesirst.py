...
.. important::
   You **must** override ``DATA_ROOT`` below to point to your local DenseSIRST
   directory before training.  The placeholder path will raise a clear
   ``FileNotFoundError`` at startup so you cannot accidentally train with
   missing cluster GT data (see the Troubleshooting section in README).
"""
import os.path as osp

# ⚠️  REPLACE THIS with the absolute path to your SIRSTdevkit directory  ⚠️
