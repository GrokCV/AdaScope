...
model = dict(
    ...
    refiner=dict(
        ...
        max_margin_scale=0.25,
        min_log_std=-5.5,
        max_log_std=-1.5,
        min_box_size=2.0,
        shift_log_std_bias=-3.5,
        margin_log_std_bias=-4.0,
        margin_mu_bias=0.0,
        preserve_raw_box=True,
    ),
...
work_dir = '/opt/data/private/cjt/BAFE-Net/work_dirs/c5_syn_rawcluster_grpo_refiner_extfcos_sirst_cluster2_3stage'
