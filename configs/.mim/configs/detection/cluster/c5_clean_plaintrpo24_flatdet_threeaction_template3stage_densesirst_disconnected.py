...
custom_imports = dict(
    imports=[
        ...
        'deepir.engine.hooks.syn_warmup_sup_policy_stage_hook',
        'deepir.evaluation.metrics.selective_voc_metric',
        'deepir.models.detectors.plain_flat_sync_clean_trpo_detector',
        'deepir.models.refine.plain_template_three_action_clean_trpo_refiner',
    ],
...
WORK_DIR = osp.join(
    REPO_ROOT,
    'work_dirs',
    'c5_clean_plaintrpo24_flatdet_threeaction_template3stage_densesirst_disconnected',
)
...
model = dict(
    type='PlainFlatSyncCleanTRPODetector',
    rl_algorithm='trpo',
    ...
    refiner=dict(
        type='PlainTemplateThreeActionCleanTRPORefiner',
        in_channels=256,
        feat_channels=256,
        num_ins=5,
        fusion_level=2,
...
val_evaluator = [
    dict(type='SelectiveVOCMetric', metric='mAP', eval_mode='11points', gt_source='instance', pred_key='pred_global_instances', prefix='global_voc'),
    dict(type='SelectiveVOCMetric', metric='mAP', eval_mode='11points', gt_source='cluster', pred_key='pred_cluster_instances', prefix='raw_cluster_voc'),
    dict(type='SelectiveVOCMetric', metric='mAP', eval_mode='11points', gt_source='cluster', pred_key='pred_refined_cluster_instances', prefix='refined_cluster_voc'),
    dict(type='SelectiveVOCMetric', metric='mAP', eval_mode='11points', gt_source='instance', pred_key='pred_local_instances', prefix='local_voc'),
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=1, save_best='merged_voc/mAP', rule='greater'),
)

custom_hooks = [
    dict(
        type='SynWarmupSupPolicyStageHook',
        warmup_epochs=12,
