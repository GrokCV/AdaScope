...
model = dict(
    ...
    external_local_cfg='configs/detection/cluster/local_proxy/gfl_r50_fpn_1x_densesirst_plugin.py',
    external_local_ckpt='',
    roi_source='refined',
...
work_dir = osp.join(
    REPO_ROOT,
    'work_dirs',
    'c5_fixed_grpo24_flatdet_threeaction_template3stage_densesirst_disconnected_gfl',
)
