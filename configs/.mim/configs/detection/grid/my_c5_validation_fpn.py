...
CUDA_VISIBLE_DEVICES=0 nohup python tools/train_det.py configs/detection/grid/my_c5_validation_fpn.py > train.log 2>&1 &

CUDA_VISIBLE_DEVICES=0  python tools/train_det.py configs/detection/grid/my_c5_validation_fpn.py 
...
model = dict(
    ...
    bbox_head=dict(
        ...
        in_channels=256,     # ResNet-50 C5 的通道数
        feat_channels=256,
        loss_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
