...
def parse_args():
    ...
    parser.add_argument(
        '--bbox-dir',
        default='/opt/data/private/cjt/data/DenseSIRST/SIRSTdevkit/SIRST/BBox',
        help='Directory with instance-level VOC XML annotations.')
    parser.add_argument(
        '--cluster1-dir',
        default='/opt/data/private/cjt/data/DenseSIRST/SIRSTdevkit/SIRST/Cluster1',
        help='Directory with the original Cluster1 XML annotations.')
    parser.add_argument(
        '--out-dir',
        default='/opt/data/private/cjt/data/DenseSIRST/SIRSTdevkit/SIRST/Cluster2',
