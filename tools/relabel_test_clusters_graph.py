...
def parse_args():
    ...
    parser.add_argument(
        '--split-file',
        default='data/DenseSIRST/SIRSTdevkit/Splits/test_v2.txt',
        help='Image id list for the test split.',
    )
    parser.add_argument(
        '--bbox-dir',
        default='data/DenseSIRST/SIRSTdevkit/test/SIRST/BBOX',
        help='Directory of instance-level VOC XML annotations.',
    )
    parser.add_argument(
        '--out-dir',
        default='data/DenseSIRST/SIRSTdevkit/test/SIRST/Cluster_relabel_graph_v1',
